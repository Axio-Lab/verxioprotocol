  ...
  return (
    <div className="max-w-4xl">
      <div className="doc-section">
        ...
        <p>
          Create and distribute individual vouchers within a collection. You can either provide a pre-uploaded metadata
...
// The protocol will upload the image, generate metadata, and use the resulting URI`}</pre>
        ...
        <table className="param-table">
          ...
          <tbody>
            <tr>
              <td>
                <span className="param-name">type</span>
              </td>
              <td>
              ...
              <td>✅</td>
              <td>
                Voucher type: 'percentage_off', 'fixed_verxio_credits', 'free_item', 'buy_one_get_one', 'custom_reward'
              </td>
            </tr>
            <tr>
              <td>
            ...
            <tr>
              <td>
                <span className="param-name">maxUses</span>
              </td>
              <td>
                <span className="param-type">number</span>
              </td>
            ...
            <tr>
              <td>
                <span className="param-name">expiryDate</span>
              </td>
              <td>
                <span className="param-type">number</span>
              </td>
            ...
            <tr>
              <td>
                <span className="param-name">conditions</span>
              </td>
              <td>
            ...
            <tr>
              <td>
                <span className="param-name">merchantId</span>
              </td>
              <td>
                <span className="param-type">string</span>
              </td>
