          ...
          <div className="rounded-lg bg-red-900/50 p-4 mt-6">
            <div className="flex">
              ...
              <div className="ml-3">
                ...
                <div className="mt-2 text-sm text-red-300">{form.formState.errors.root.message}</div>
              </div>
            </div>
          </div>
        )}
                  ...
                  <div key={broadcast.id} className="p-4 bg-gray-700/50 rounded-lg">
                    <div className="flex items-start justify-between">
                      <div className="space-y-2">
                        ...
                        <p className="text-sm text-gray-400">From: {broadcast.sender}</p>
                        <p className="text-sm text-gray-400">{new Date(broadcast.timestamp).toLocaleString()}</p>
                      </div>
                      {!broadcast.read && (
                  ...
                  <div key={message.id} className="p-4 bg-gray-700/50 rounded-lg">
                    <div className="flex items-start justify-between">
                      <div className="space-y-2">
                        ...
                        <p className="text-sm text-gray-400">From: {message.sender}</p>
