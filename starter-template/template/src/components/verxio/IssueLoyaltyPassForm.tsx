            ...
            <TabsContent value="image" className="space-y-4">
              <VerxioFormField label="Pass Image">
                <div className="flex items-center gap-4">
                  ...
                  />
                  {selectedFile && <div className="text-sm text-gray-400">Selected: {selectedFile.name}</div>}
                </div>
              </VerxioFormField>
              <Alert>
                <AlertDescription>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="md:col-span-2 space-y-4">
              ...
              <div className="p-4 bg-blue-900/50 rounded-lg">
                <p className="text-blue-200">Your loyalty pass has been issued successfully! You can now:</p>
